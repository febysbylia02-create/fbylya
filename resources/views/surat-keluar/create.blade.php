                ...
                <form action="{{ route('surat-keluar.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nomor_urut" id="nomor_urut" class="form-control"
                                value="{{ old('nomor_urut', $suratKeluarCount + 1) }}" required>
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nomor_berkas" id="nomor_berkas" class="form-control"
                                placeholder="Contoh: 005/678.1" value="{{ old('nomor_berkas') }}" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="tanggal_surat" id="tanggal_surat" class="form-control"
                            value="{{ old('tanggal_surat', now()->format('Y-m-d')) }}" required>
                    </div>
