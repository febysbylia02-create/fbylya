                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text"
                               ...
                               id="nomor_urut"
                               class="form-control"
                               value="{{ old('nomor_urut', $suratKeluar->nomor_urut) }}"
                               required>
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('nomor_berkas', $suratKeluar->nomor_berkas) }}"
                               required>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select name="arsip_surat_id" id="arsip_surat_id" class="form-select" required>
                        ...
                        @foreach($arsipSurats as $arsip)
                            <option value="{{ $arsip->id }}" @if(old('arsip_surat_id', $suratKeluar->arsip_surat_id) == $arsip->id) selected @endif>
                                {{ $arsip->file_path }} ({{ $arsip->tanggal_arsip }})
                            </option>
                        @endforeach
                    </select>
                </div>
